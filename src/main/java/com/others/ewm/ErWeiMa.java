...
public class ErWeiMa {
    ...
    public boolean createQrCode(OutputStream outputStream, String content, int qrCodeSize, String imageFormat) throws WriterException, IOException {
        ...
        BitMatrix byteMatrix = qrCodeWriter.encode(content, BarcodeFormat.QR_CODE, qrCodeSize, qrCodeSize, hashtable);
    ...
    public static void main(String[] args) throws IOException, WriterException {
        ...
        erWeiMa.createQrCode(new FileOutputStream(new File("d:\\qrcode.jpg")), "zhi neng shu ru ying wei zi mu", 640, "JPEG");
        File file=new File("d:\\qrcode.jpg");
        InputStream inputStream=new FileInputStream(file);
        erWeiMa.readQrCode(inputStream);
        inputStream.close();
    }
}
