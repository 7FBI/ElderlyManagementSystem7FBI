                        ...
                        <tr>
                            ...
                            <td width="96%">
                                <table width="100%">
                                    <tr>
                                        <td colspan="2">
                                            <form action="${pageContext.request.contextPath }/backstage/Class/update_sucssful.action" method="post">
                                                <table width="100%" class="cont">
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="10%"></td>
                                                        <td width="20%"><input class="text" type="hidden" name="id" value="${classification.id }" /></td>
                                                        <td></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td>类别名称</td>
                                                        <td><input class="text" type="text" name="classname"  value="${classification.classname }" /></td>
                                                        <td>请输入你要修改的类别名称</td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
