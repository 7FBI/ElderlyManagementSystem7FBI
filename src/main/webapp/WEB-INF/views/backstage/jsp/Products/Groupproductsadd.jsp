            ...
            <tr>
                ...
                <td valign="top" background="/resources/backstage/Images/content_bg.gif">
                    <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" background="/resources/backstage/Images/content_bg.gif">
                        <tr><td height="31"><div class="title" style="100px;">团购商品</div></td></tr>
                    </table>
                </td>
                                        ...
                                        <td colspan="2">
                                                <table width="100%" class="cont">
                                                    ...
                                                    <tr>
                                                     ...
                                                     <form action=""  id="fromSubmin">
                                                     <input value="${product.id}" name="pid" type="hidden">
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td>商品团购价：</td>
                                                        <td width="20%"><input class="text" type="text" name="groupprice" value=""/></td>
                                                        <td width="40%"></td>
                                                        <td width="20%"></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                     <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td>商品团购最低人数：</td>
                                                        <td width="20%"><input class="text" type="text" name="grouppeople" value=""/></td>
                                                        <td width="40%"></td>
                                                        <td width="20%"></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                     <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td>商品团购截止时间：</td>
                                                        <td width="20%"><input id="date" class="text" type="text" name="groupstoptime" value=""/></td>
                                                        <td width="40%"></td>
                                                        <td width="20%"></td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
...
$("button[url]").on('click',function(){
	 ...
	 var yi=$(this).attr("id");
	 if(yi=="btn_1"){
		if(values.val()!=null&&values.val()>0){
			window.location.href="/backstage/Store/addOnegroup.action?pname=null&id="+values.val();
		}else{
			alert("请输入商品id或者商品名称")
		} 
	 }else if(yi=="btn_2"){
		 if(values.val()!=null){
				window.location.href="/backstage/Store/addOnegroup.action?id=0&pname="+values.val();
			}else{
				alert("请输入商品id或者商品名称")
			}
	 }
...
$(".btn").click(function(){
	...
	if(tosy[0]==mydate.getFullYear()&&tosy[1]==mydate.getMonth()&&tosy[2]<=mydate.getDate()){
		alert("团购截止时间年份不能早于当前时间")
		 ...
		 $.ajax({
				type : 'post',
				url :"/front/groupbuying/insertGroupproducts.action",
				data : f.serialize(),
