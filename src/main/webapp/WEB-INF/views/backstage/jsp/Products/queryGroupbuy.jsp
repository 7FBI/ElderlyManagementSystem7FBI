...
<body>
		...
		<tr>
			...
			<td valign="top"
				...
				<table width="100%" height="31" border="0" cellpadding="0"
					...
					background="resources/backstage/Images/content_bg.gif">
					<tr>
						<td height="31"><div class="title">查看商品</div></td>
					</tr>
				</table>
			</td>
								...
								<tbody>
									<tr>
										<div id="baidu">
											<div class="input">
												<form
													action="${pageContext.request.contextPath }/backstage/groupbuying/queryGroupbuy.do"
													method="post">
											...
											<table width="100%" class="cont tr_color">
												...
												<c:forEach items="${InvList }" var="Invlist">
													<tr align="center" class="d" p=${Invlist.id }>
														...
														<td>${Invlist.count}</td>
														<td>${Invlist.tid}</td>
														<td>${Invlist.groupprice}</td>
														<td>${Invlist.grouppeople}</td>
														<td><fmt:formatDate value="${Invlist.groupstoptime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
														<td><a href="${pageContext.request.contextPath}/backstage/groupbuying/delectGroupbuy.action?pid=${Invlist.id}">删除</a></td>
													</tr>
												</c:forEach>
							...
							<table width="100%" height="40px" border="0" cellpadding="0"
								...
								<tbody>
									<tr>
										...
										<td><a href="/front/groupbuying/queryGroupbuy.do?currentPage=0">首页</a>
											<a
											href="/front/groupbuying/queryGroupbuy.do?currentPage=${page.currentPage-1}"
											onclick="return checkFirst()">上一页</a> <a
											href="/front/groupbuying/queryGroupbuy.do?currentPage=${page.currentPage+1}"
											onclick="return checkNext()">下一页</a></td>
										<td><a
											href="/front/groupbuying/queryGroupbuy.do?currentPage=${page.totalPage}">尾页</a>
    ...
    var shref="queryGroupbuy.do?currentPage="+turnPage; 
