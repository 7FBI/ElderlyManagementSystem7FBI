...
<body>
				...
				<table width="100%" border="0" align="center" cellpadding="0"
					...
					<tr>
						...
						<td colspan="2" valign="top"><img
							src="/resources/backstage/Images/ts.gif" width="16" height="16"
							style="margin-left: 10px;"> 提示：<br /></td>
						<!--间隔-->
						<td width="7%">&nbsp;</td>
						<!--右边内容-->
							...
							<table width="100%" height="150" border="0" cellpadding="0"
								...
								<tr>
									<td width="7%" height="27"
										background="/resources/backstage/Images/news_title_bg.gif">
										<img src="/resources/backstage/Images/news_title_bg.gif"
										width="2" height="27">
									</td>
									<td width="93%"
										background="/resources/backstage/Images/news_title_bg.gif"
										class="left_bt">最新动态</td>
								</tr>
								<tr>
								...
								<tr>
									<td height="100" valign="top" colspan="2" id="news"><marquee
											direction="up" scrollamount="2" vspace="30px" width="400px"
											height="100px" onmouseout="this.start()"
											onmouseover="this.stop()">
											<ul id="backinrformation">
	...
	<script type="text/javascript">
		$(document).ready(
				function() {
					var u = $("#backinrformation");
					$.ajax({
						type : 'get',
						url : '/backstage/backinformation/selectByAuthor',
						success : function(data) {
							if (data != null) {
								for ( var k in data) {
									var l = '<li><a href="/backstage/backinformation/selectByPrimaryKey/?id='                
											+ data[k].id + '">' + data[k].title
											+ '</a></li>';
									u.append(l);
								}
							} else {
