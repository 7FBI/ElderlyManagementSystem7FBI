								...
								<div class="form-group col-md-offset-3">
									...
									<div class="col-sm-3">
										<input type="text" class="form-control" name="idcard"
											id="idcard" onblur="checkCard()" placeholder="身份证号">
									</div>
									<div class="pleft">
				...
				<div class="input-group date">
								...
								<div class="form-group col-md-offset-3">
									...
									<div class="col-sm-3">
										<input type="text" class="form-control" name="tell" id="tell"
											onblur="checkTell()" placeholder="电话"> <input
											type="hidden" class="form-control" name="balance"
											id="balance" value="0.00" onblur="checkTell()"
											placeholder="余额">
									</div>
									<div class="pleft">
					...
					<option value="6">天津</option>
								...
								<div class="form-group col-md-offset-3">
									...
									<div class="col-sm-3">
										<input type="text" class="form-control" name="address"
											id="address" onblur="checkAddress()" placeholder="住址">
									</div>
									<div class="pleft">
								...
								<div class="form-group col-md-offset-3">
									...
									<div class="col-sm-3">
										<input type="text" class="form-control" name="uid" id="uid"
											onblur="uidCheck()" placeholder="登录账号">
								...
								<div class="form-group col-md-offset-3">
									...
									<div class="col-sm-3">
										<input type="password" class="form-control" name="password"
											id="password" onblur="passwordCheck()" placeholder="密码">
								...
								<div class="form-group col-md-offset-3">
									...
									<div class="col-sm-3">
										<input type="password" class="form-control" id="pass_wd"
											onblur="pass_wdCheck()" />
