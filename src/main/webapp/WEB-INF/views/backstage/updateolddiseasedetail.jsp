...
<script type="text/javascript" language="javascript"
	src="/resources/js/cloudjob.js"></script>
<style type="text/css">
.autocomplete {
...
<body>
	...
	<form class="form-horizontal col-md-offset-2"
		action="/backstageOldDiseasedetails/update.action" method="post"
		enctype="multipart/form-data">

		<label class="register_title"> <strong> <span
				class="glyphicon glyphicon-user" aria-hidden="true"> </span>&nbsp;修改病例记录
		</strong></label>
		...
		<div class="form-group col-md-offset-3">
			...
			<div class="col-sm-3">
				<input type="hidden" class="form-control" name="id" id="id"
					value="${listOldDiseasedetail.id}"> <input type="text"
					class="form-control" name="uid" id="uid" value="${uid}"
					readonly="readonly">
			</div>
			<div class="pleft">
		...
		<div class="form-group col-md-offset-3">
			...
			<div class="col-sm-3 am-datepicker-date">
				...
				<input type="date" class="form-control" name="treatTiem"
					id="treatTiem" value="${listOldDiseasedetail.treatTiem}">
			</div>
			<div class="pleft">
		...
		<div class="form-group col-md-offset-3">
			...
			<div class="col-sm-3">
				<textarea class="form-control" name="diseaselist" rows="3" cols="50"
					id="diseaselist">${diseasename}</textarea>
			</div>
		</div>
		<div class="form-group col-md-offset-3">
			<label for="address" class="col-sm-2 control-label">就诊意见</label>
			<div class="col-sm-3">
				<textarea class="form-control" name="suggest" rows="3" cols="50">${listOldDiseasedetail.suggest}</textarea>
			</div>
			<div class="pleft">
		...
		<div class="form-group col-md-offset-3">
			...
			<div class="col-sm-3">
				<textarea type="text" class="form-control" name="history" rows="3"
					cols="50">${listOldDiseasedetail.history}</textarea>
