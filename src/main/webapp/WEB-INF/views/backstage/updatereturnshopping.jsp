...
<body>
	...
	<form class="form-horizontal col-md-offset-2"
		action="/returnshopping/update.action?returnid=${returnid}" method="post"
		enctype="multipart/form-data">

		<label class="register_title"> <strong> <span
				class="glyphicon glyphicon-user" aria-hidden="true"> </span>&nbsp;修改回访记录
		</strong></label>
			...
			<div class="form-group col-md-offset-3">
				...
				<div class="col-sm-3 am-datepicker-date">
					...
					<input style="width:50px ;height:30px ;text-align:right;" id="pcount" name="shoppingcount" value="${returnshopping.shoppingcount}"/>&nbsp;&nbsp;
