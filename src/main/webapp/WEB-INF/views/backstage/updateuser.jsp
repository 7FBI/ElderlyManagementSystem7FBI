					...
					<tr>
						<td>
							<div class="col-md-offset-2"
								style="font-size: 26px;color: #9fdfdc;font-family: "
								楷体";text-align:left;width:80%; margin: 0 auto;">
								<label style="font-family: "楷体";"> <span
							...
							</div> <%-- <a  href="${pageContext.request.contextPath}/oldusers/queryAllUsers.action" ><font  color="blue"> 
	...
	<br> --%>
				...
				class="glyphicon glyphicon-user" aria-hidden="true"> </span>&nbsp;修改用户信息
								...
								<div class="form-group col-md-offset-3">
									...
									<div class="col-sm-3">
										<input type="text" class="form-control" name="username"
											value="${userbyid.username}" id="username"
											onblur="usenameCheck()">
								...
								<div class="form-group col-md-offset-3">
									...
									<div class="col-sm-3 ">
										&nbsp;&nbsp;<input type="radio" name="sex" id="group1"
											value="0" checked="checked"><label>男</label>
										&nbsp;&nbsp; <input type="radio" name="sex" id="group2"
											value="1"><label>女</label>
									</div>
									<div class="pleft">
										<p class="msg">
											<i class="ati"></i>
					...
					> 
									...
									<div class="col-sm-3 am-datepicker-date">
										<input type="date" class="form-control" name="birthday"
											value="${userbyid.birthday}" id="birthday"
											onblur="checkBirthday()">
									</div>
									<div class="pleft">
										<font color="red"><p id="error9"></p></font> <font
											color="green"><p id="success9"></p></font>
									</div>
								</div>
								...
								<div class="form-group col-md-offset-3">
									...
									<div class="col-sm-3">
										<input type="hidden" name="id" value="${userbyid.id}" /> <input
											...
											value="${userbyid.tell}" id="tell" onblur="checkTell()">
									</div>
									<div class="pleft">
								...
								<div class="form-group col-md-offset-3">
									...
									<div class="col-sm-3">
										<input type="text" class="form-control" id="tells" value="${userbyid.localarea.provincename}" readonly>
									<input type="hidden" class="form-control" name="area"
											value="${userbyid.area}" readonly>
									</div>
								</div>
								<div class="form-group col-md-offset-3">
									...
									<div class="col-sm-3">
										<input type="text" class="form-control" name="address"
											value="${userbyid.address}" id="address"
											onblur="checkAddress()">
									</div>
									<div class="pleft">
								...
								<div class="form-group col-md-offset-3">
									...
									<div class="col-sm-3">
										<input type="password" class="form-control" name="password"
											value="${userbyid.password}" id="password"
								...
								<div class="form-group col-md-offset-3">
									...
									<div class="col-sm-3">
										<input type="password" class="form-control"
											value="${userbyid.password} id="
											pass_wd" onblur="pass_wdCheck()" />
								...
								<div class="form-group col-md-offset-3">
									...
									<div class="col-sm-3">
										<input type="file" name="file" multiple="multiple"
											id="userurl" value="${userbyid.userurl}" onblur="checkUrl()" />
									</div>
									<div class="pleft">
