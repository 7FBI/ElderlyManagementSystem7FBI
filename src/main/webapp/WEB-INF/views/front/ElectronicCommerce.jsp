...
<title>搜索页面</title>
		...
		<link href="/resources/front/css/self_exchange/demo.css" rel="stylesheet" type="text/css" />

		<link href="/resources/front/css/self_exchange/seastyle.css" rel="stylesheet" type="text/css" />

		<script type="text/javascript" src="/resources/front/js/self_exchange/jquery-1.7.min.js"></script>
		<script type="text/javascript" src="/resources/front/js/self_exchange/script.js"></script>
</head>
								...
								<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
									...
									<li>
										<div class="i-pic limit">
											...
											<p class="title fl">										<a href="/front/products/selectProductDetailByPrimaryKey?id=${products.id }">${products.pname}</a>
</p>
											<p class="price fl">
												<b>¥</b>
