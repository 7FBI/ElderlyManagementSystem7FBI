...
<body>
		...
		<div class="paycont">
			...
			<c:if test="${orders.orderstatus==0 }">
				<div class="address">
					<h3>确认收货地址</h3>
					<div class="control">
						<input type="button" id="secondsBtn"
							class="tc-btn createAddr theme-login am-btn am-btn-danger"
							value="使用新地址">
					</div>
					<div class="clear"></div>
						...
						<ul id="profiles">
							...
							<li class="user-addresslist defaultAddr">
								...
								<div class="address-left">
									<div class="user DefaultAddr">
										...
										<span class="buy-address-detail"> <span
											class="buy-user">${profiles.signname } </span> <span
											class="buy-phone">${profiles.signtell }</span>
										</span>
									</div>
									<div class="default-address DefaultAddr">
										<span class="buy-line-title buy-line-title-type">收货地址：</span>
										<span class="buy--address-detail">
											${profiles.signaddress} </span>
									</div>
								</div>
								...
								<div class="new-addr-btn">
									<a href="#overOrderBtn" setAdd="${profiles.id }"
										r="${profiles.signaddress}" t="${profiles.signtell }"
										m="${profiles.signname }">设为默认</a> <span
										class="new-addr-bar hidden">|</span> <a
										href="/front/oldUsers/updateAddressjsp?id=${profiles.id }&uid=${oldUsers.uid}">编辑</a>
									<span class="new-addr-bar">|</span> <a href="#"
										de="${profiles.id }" name="delBtn">删除</a>
								</div>
							</li>
										...
										<li class="td td-item">
											...
											<div class="item-info">
												<div class="item-basic-info">
													<a
														href="/front/products/selectProductDetailByPrimaryKey?id=${ord.pid}"
														target="_blank" title="${ord.products.pname}"
										...
										<div class="amount-wrapper ">
											<div class="item-amount ">
												...
												<div class="sl" style="text-align: center;">
													...
													<input class="text_box" name="ordercount"
														disabled="disabled" type="text" value="${ord.ordercount}"
				...
				<div class="pay-confirm clearfix">
						...
						<div id="holyshit268" class="pay-address">
							<p class="buy-footer-address">
								<span class="buy-line-title buy-line-title-type">寄送至：</span> <span
									class="buy--address-detail" id="toaddress">
									${orders.orderaddress } </span>
							</p>
							<p class="buy-footer-address">
								<span class="buy-line-title">收货人：</span> <span
									class="buy-address-detail"> <span class="buy-user"
									id="toman">${orders.orderman }</span> <span class="buy-phone"
									id="totell">${orders.tell }</span>
								</span>
							</p>
						</div>
					</div>
					...
					<div id="holyshit269" class="submitOrder">
						<div class="go-btn-wrap">
							<form id="f">
								<input type="hidden" value="" name="tell" /> <input
									type="hidden" value="" name="orderaddress" /> <input
									type="hidden" value="" name="orderman" /> <input type="hidden"
									value="${orders.money }" name="money" />
							</form>
	...
	<script type="text/javascript">
												...
												layer.open({
															...
															success : function(
																...
																function removeEle(
																	...
																	ele
																			.find(
																					"option")
																			.remove();
																	var optionStar = "<option value="+"请选择"+">"
																			+ "请选择"
																			+ "</option>";
																	ele
																			.append(optionStar);
																...
																province.on("change",function() {
																					...
																					$
																							.each(
																									provinceList[cityItem].cityList,
																									function(
																											i,
																											item) {
																										addEle(
																...
																city
																		.on(
																				...
																				function() {
																					...
																					$.each(provinceList[cityItem].cityList,function(
																											i,
																											item) {
			...
			$.ajax({
				...
				success : function(data) {
					...
					case "balance":
						...
						break;
					default:
						window.location.href = "/front/orders/goOrderOver?id="+o.attr("vve");
						break;
					}
				},
				error : function() {
		...
		$(document).on(
				...
				function() {
					var dels = $(this);
					var hrs = "/front/oldUsers/deleteAddressByPrimarykey?id="
							+ dels.attr("de");
					$.ajax({
						type : 'post',
						url : hrs,
									...
									.ajax({
										...
										success : function(data) {
											...
											case "balance":
												...
												break;
											default:
												window.location.href = "/front/orders/ordersOverInfoByExchange?id="
														+ ords.attr("vve");
												break;
											}
										},
