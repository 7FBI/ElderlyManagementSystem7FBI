				...
				<div class="user-address">
					...
					<ul class="am-avg-sm-1 am-avg-md-3 am-thumbnails"
						...
						<c:forEach items="${profiles}" var="profiles">
							<li class="user-addresslist defaultAddr"
								style="margin-bottom: 10px;"><span class="new-option-r"></span>
								<p class="new-tit new-p-re">
									<span class="new-txt">${profiles.signname }</span> <span
										class="new-txt-rd2">${profile.signtell }</span>
								</p>
								<div class="new-mu_l2a new-p-re">
									<p class="new-mu_l2cw">
										<span class="street">${profiles.signaddress}</span>
									</p>
								</div>
								<div class="new-addr-btn">
									<a
										href="/front/oldUsers/updateAddressjsp?id=${profiles.id}&&uid=${profiles.uid}"><i
										class="am-icon-edit"></i>编辑</a> <span class="new-addr-bar">|</span>
									<a
										href="/front/oldUsers/deleteAddressByPrimarykey?id=${profiles.id}&&uid=${profiles.uid}"><i
					...
					<div class="add-dress">
						...
						<div class="am-u-md-12 am-u-lg-8"
							...
							<form class="am-form am-form-horizontal" action=<%=url%>
								id="addr_form" method="post">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input name="signtell" value="${ profile.signtell}"
											id="signtell" placeholder="手机号必填" type="text">
									</div>
								</div>
								<div class="am-form-group">
									<label for="user-address" class="am-form-label">所在地</label>
									<div class="am-form-content address outer">
