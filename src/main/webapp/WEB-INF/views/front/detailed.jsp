...
<a id="gotoshoppay" class="layer_btn J_get_href" href="/front/Shoppingcart/selectproducts.action?uid=1">去结算</a>
</div>
</div>
...
<div class="mod_layer_ft">
<a class="layer_btn" href="/front/Shoppingcart/selectproducts.action?uid=${oldUsers.id}">整理购物车</a>
<a id="btnCartBuy" class="layer_btn" >立即购买</a>
</div>
</div>
  ...
  $(".close_ico").click(function(){
	     var gh=$(this);
	     var pre=gh.parent("div");
	     var pare=pre.parent("div");
	     pare.removeClass("mod_lary show").addClass('mod_lary');
  })
  
  $("#pays").click(function(){
	  var f=$("#fromSubmin");
	  f.attr('action',"/front/orders/addOneOrder");
	  f.submit();
  }) 
  ...
  $("#btnCollect").click(function(){
	  ...
	  $.ajax({
		 type:'post', 
		 url:"/front/collection/insert_or_delete",
		 data:f.serialize(pid),
		 success:function(data){
			 if(data=="ture"){
