...
<link rel="shortcut icon"
	href="/resources/front/product/images/favicon.ico" />
<link rel="stylesheet" href="/resources/front/product/css/global.css" />
<link rel="stylesheet"
	href="/resources/front/product/css/order_list_v2.css" />
			...
			<div class="side_bar_wrap">
				<ul class="side_bar_nav">
					<li class="side_bar_nav_li"><a class="bar_main_title my_midea"
						href="#"> <span class="side_bar_nav_word">我的空间</span>
					</a></li>
					...
					<li class="side_bar_nav_li"><a class="sub_title js_red_dot"
						href="#" data-type="collect"> <span class="side_bar_nav_word">我的收藏</span>
							<i class="tag tag_cut js_collect_tag hide"></i>
					</a></li>
					<li class="side_bar_nav_li"><a class="sub_title" href="#">
							<span class="side_bar_nav_word">评价管理</span>
					</a></li>
					<li class="side_bar_nav_li"><a class="sub_title" href="#">
							<span class="side_bar_nav_word">我的积分</span>
					</a></li>
				</ul>
			</div>
				...
				<div class="order_wrap">
					<ul class="order_tab_box clearfix js_order_tap">
						<li id="typeTab0" data-deal-state="-1" data-mtag="30033.1.1">
							<a href="/front/orders/allOrdersList" class="active">所有订单</a>
						</li>
						<li id="typeTab1" data-deal-state="0" data-mtag="30033.1.2">
							<a href="/front/orders/allOrdersList?status=0">待付款</a>
						</li>
